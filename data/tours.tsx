const tours = [
  {
    ...
    slideImg: ["/assets/img/tours/1.png"],
  ...
  },
  {
    ...
    tag: "",
    slideImg: [
      "/assets/img/tours/2.png",
      "/assets/img/tours/1.png",
      "/assets/img/tours/3.png",
    ],
...

  {
    id: 3,
    tag: "best seller",
    slideImg: ["assets/img/tours/3.png"],
  ...
  },
  {
    id: 4,
    tag: "top rated",
    slideImg: ["assets/img/tours/4.png"],
  ...
  },
  {
    id: 5,
    tag: "LIKELY TO SELL OUT*",
    slideImg: ["assets/img/tours/5.png"],
    title: "Stonehenge, Windsor Castle and Bath with Pub Lunch in Lacock",
    location: "Westminster Borough, London",
    duration: "16",
    numberOfReviews: "3014",
  ...
  },
  {
    ...
    tag: "",
    slideImg: [
      "assets/img/tours/6.png",
      "assets/img/tours/7.png",
      "assets/img/tours/8.png",
    ],
    title: "Westminster Walking Tour & Westminster Abbey Entry",
    location: "Ciutat Vella, Barcelona",
    duration: "14",
  ...
  },
  {
    id: 7,
    tag: "best seller",
    slideImg: ["assets/img/tours/7.png"],
    title: "High-Speed Thames River RIB Cruise in London",
    location: "Manhattan, New York",
    duration: "18",
    numberOfReviews: "2163",
  ...
  },
  {
    id: 8,
    tag: "top rated",
    slideImg: ["assets/img/tours/8.png"],
    title: "Edinburgh Darkside Walking Tour: Mysteries, Murder and Legends",
    location: "Vaticano Prati, Rome",
    duration: "20",
    numberOfReviews: "1458",
  ...
  },
  {
    id: 9,
    tag: "best seller",
    slideImg: ["assets/img/tours/9.png"],
    title: "High-Speed Thames River RIB Cruise in London",
    location: "Manhattan, New York",
    duration: "18",
    numberOfReviews: "2163",
