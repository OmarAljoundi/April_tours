...
const data = [
  ...
  {
    image: "/assets/img/custom/mountains.png",
    title: "جولات سياحية",
    description:
      "سوف تكتشف جمال المعالم السياحية برفاهية وراحة مع خدمات الجولات السياحية الخاصة أو الجماعية التي نوفرها في ابريل تورز، حيث نقدم تجربة سفر استثنائية تلبي توقعاتك وتجعل كل لحظة لا تُنسى",
  },
  {
